...
YTDL_OPTIONS = {
    "format": "bestaudio[ext=m4a]/bestaudio/best",  # Ưu tiên m4a, fallback linh hoạt
    "noplaylist": False,
    ...
    "extractor_args": {
        "youtube": {
            # Bỏ skip cứng, để yt-dlp tự quyết định
    ...
    async def play(self, interaction: discord.Interaction, query: str):
        ...
        try:
            ...
            if "403" in msg or "Sign in" in msg:
                ...
                tip = "⚠️ Không tìm thấy định dạng âm thanh phù hợp. Thử dùng link khác."
            else:
