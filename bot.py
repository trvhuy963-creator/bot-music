...
# ========== CẤU HÌNH YT-DLP (ĐÃ FIX LỖI 403) ==========
YTDL_OPTIONS = {
    ...
    # 🔑 Dùng cookie từ Chrome (máy phải có Chrome đã đăng nhập YouTube)
    "cookiesfrombrowser": ("chrome",),
    # Nếu không có Chrome, thay bằng dòng dưới và đặt file cookies.txt cùng thư mục:
    ...
    async def play(self, interaction: discord.Interaction, query: str):
        ...
        try:
            ...
            if "403" in msg or "Sign in" in msg:
                tip = "🔒 YouTube yêu cầu xác thực. Hãy đảm bảo bạn đã đăng nhập Chrome và dùng cookiesfrombrowser, hoặc dùng file cookies.txt."
            elif "Private" in msg:
