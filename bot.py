...
# ========== CẤU HÌNH YT-DLP (ĐÃ SỬA: dùng cookies.txt) ==========
YTDL_OPTIONS = {
    ...
    # 🔑 Dùng file cookies.txt (phải đặt cùng thư mục với bot)
    ...
    async def play(self, interaction: discord.Interaction, query: str):
        ...
        try:
            ...
            if "403" in msg or "Sign in" in msg:
                tip = "🔒 YouTube yêu cầu xác thực. Hãy kiểm tra file cookies.txt (định dạng Netscape) hoặc tạo lại."
            elif "Private" in msg:
